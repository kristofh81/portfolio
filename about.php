<?php 
	...
	$pageTitle = "Kristof Hamelryckx Portfolio - About me";
	$section = "about";
...
?>
			...
			<article id="intro">
				...
				<section id="currently">
					...
					<a href="http://www.intecbrussel.be/Werkzoekende/WerkzoekendeHome/PHPenDrupalDeveloperontwinternetplatformen.aspx">at <u>Intec Brussel</u>, in Brussels, 1 year from may 2014.</a></p>
				</section>
				<br>
				<section id="currently">
					<h2>What's on my mind now?...</h2>
					<p>I would like to sharpen some of my skills and knowledge...</p>
					My wishlist :<br>
					<ol>
						<li>studying on Laravel 5 (just came out last march!)</li>
